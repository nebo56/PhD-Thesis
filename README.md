...
Ratio of single strandedness around cDNA-ends (from less than 40 nt long cDNAs) compared to the central region between -15 to -5 nt upstream from cDNA end. Single strandedness was measured same as above in a 30 nt surrounding region (REF: see 2.7.7 Analysis of pairing probability).
