...
coverage3SS.5SSA <- data3SS.5SS.input
coverage3SS.5SSA[coverage3SS.5SSA < 2] <- 0
coverage3SS.5SSA[coverage3SS.5SSA >= 2] <- 1
sum.data3SSinput <- colSums(coverage3SS.5SSA[,4:354], na.rm = FALSE, dims = 1)
sum.data5SSinput <- colSums(coverage3SS.5SSA[,857:1207], na.rm = FALSE, dims = 1)
sum.3SSA.norm <- sum.data3SSinput / num.reg.exons 
sum.5SSA.norm <- sum.data5SSinput / num.reg.exons 
sum.3SSA.norm.smooth <- smth(sum.3SSA.norm, window = 10, method = "gaussian") #SMOOTHING
sum.5SSA.norm.smooth <- smth(sum.5SSA.norm, window = 10, method = "gaussian") #SMOOTHING
...
# calculate cluster coverage
control.coverage3SS.5SSA <- control3SS.5SSA
control.coverage3SS.5SSA[control.coverage3SS.5SSA < 2] <- 0
control.coverage3SS.5SSA[control.coverage3SS.5SSA >= 2] <- 1
sum.control3SSinput <- colSums(control.coverage3SS.5SSA[,4:354], na.rm = FALSE, dims = 1)
sum.control5SSinput <- colSums(control.coverage3SS.5SSA[,857:1207], na.rm = FALSE, dims = 1)
...
sum.control.3SSA.norm.smooth <- smth(sum.control.3SSA.norm, window = 10, method = "gaussian") #SMOOTHING
sum.control.5SSA.norm.smooth <- smth(sum.control.5SSA.norm, window = 10, method = "gaussian") #SMOOTHING
